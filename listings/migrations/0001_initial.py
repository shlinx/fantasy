# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-15 10:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height', models.SmallIntegerField()),
                ('url', models.TextField()),
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.TNZImage')),
            ],
        ),
        migrations.CreateModel(
            name='TNZListing',
            fields=[
                ...
                ('logo_image', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='logo_image_listing', to='listings.TNZImage')),
                ('main_image', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='main_image_listing', to='listings.TNZImage')),
            ],
        ),
        migrations.CreateModel(
            name='TNZRegion',
        ...
        migrations.AddField(
            ...
            name='tags',
            field=models.ManyToManyField(to='listings.TNZTag'),
        ),
        migrations.AddField(
            model_name='tnzimage',
            name='gallery_image_listing',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gallery_images', to='listings.TNZListing'),
        ),
    ]
